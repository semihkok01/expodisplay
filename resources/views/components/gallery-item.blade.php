...
<article class="gallery-card panel group h-full overflow-hidden js-tilt" data-animate-item>
    ...
    >
        <div class="relative overflow-hidden">
            ...
            <span class="gallery-action absolute inset-x-4 bottom-4 inline-flex items-center justify-center rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white">
                Entdecken
            </span>
        </div>
        ...
        <div class="flex flex-1 flex-col gap-3 p-5">
            ...
            <p class="text-sm text-muted">Premium Screen-Design, optimiert fuer hohe Aufmerksamkeit und klare Markenwirkung.</p>
        </div>
    </button>
</article>
